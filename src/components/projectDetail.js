...
//             {
//                   data?.updated_by?.profile_picture ? <img src={picture?.thumbnail_image} alt="thumbnail" className="w-10 h-10 rounded-full"/> : <p className="bg-yellow-600 h-fit w-fit py-3 px-4 capitalize rounded-full">{picture?.updated_by?.username.slice(0, 2)}</p>
//                 }
